                    ...
                    Container(
                      ...
                      child: ListView(
                        ...
                        children: [
                          ...
                          SizedBox(height: 8.h),
                          Text(
                            '${state.item.created?.firstname}  '
                            '${state.item.created?.lastname}',
                            style: TextStyle(
                              fontSize: 12.sp,
                              fontWeight: FontWeight.bold,
                            ),
                          ),
                          if (state.item.authorPosition.label.isNotEmpty)
                            Row(
                              children: [
                                Text(
                                  'Position: ',
                                ...
                                Text(
                                  state.item.authorPosition.label,
                                  style: TextStyle(
                                    fontSize: 12.sp,
                                    fontWeight: FontWeight.w400,
                                  ),
                          ...
                          if (state.item.authorDepartment.label.isNotEmpty)
                            Row(
                              children: [
                                Text(
                                  'Department: ',
                                ...
                                Expanded(
                                  child: Text(
                                    state.item.authorDepartment.label,
                                    style: TextStyle(
                                      fontSize: 12.sp,
                                      fontWeight: FontWeight.w400,
                                    ),
                          ...
                          SizedBox(height: 8.h),
                          Text(
                            state.item.recipientCustom,
                            style: TextStyle(
                              fontSize: 12.sp,
                              fontWeight: FontWeight.bold,
                            ),
                          ),
                          if (state.item.recipientPostion.isNotEmpty)
                            Row(
                              children: [
                                Text(
                                  'Position: ',
                          ...
                          if (state.item.recipientDepartment.isNotEmpty)
                            Row(
                              children: [
                                Text(
                                  'Department: ',
                                ...
                                Expanded(
                                  child: Text(
                                    state.item.recipientDepartment,
                                    style: TextStyle(
                                      fontSize: 12.sp,
                                      fontWeight: FontWeight.w400,
                                    ),
